...
/**
 * Filtra los PPT y PPTX y convierte la primera pagina en una imagen. Luego
 * utiliza el filtro JPEFFilter para redimensionar la imagen segun los
 * parametros de DSpace
 *
 * @author jtrenado
 */
